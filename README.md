...
tests/               dependency-free unittest suite (537 tests, all mocked)
  l2/
...
| `TESTS_PROOF.md` | The dependency-free unit suite, raw output (regenerated by `gates/test_suite.py`; 537 tests) |
