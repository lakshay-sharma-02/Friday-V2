...
protected windows, dangerous-dev gate); a **535-test unit suite** covers
...
tests/               dependency-free unittest suite (535 tests, all mocked)
  l2/
...
| `TESTS_PROOF.md` | The dependency-free unit suite, raw output (regenerated by `gates/test_suite.py`; 535 tests) |
